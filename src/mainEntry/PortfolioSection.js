    ...
    <>
      <div className="portfolio-wrapper">
        ...
        <div className="portfolio-section">
          ...
          <a href="https://leddfoot-test.herokuapp.com/">
          <img
        ...
        <div className="portfolio-section">
          ...
          <div className="image-container">
          <a href="https://fcc-docs.herokuapp.com/">
        ...
        <div className="portfolio-section">
          ...
          <h2>#TLDR: html, css, javascript, react, mobile first</h2>
            ...
            <p>The code repository for the product landing page project is on <a href="https://github.com/Leddfoot/landing_page_fcc">Github</a>. It is deployed live at Heroku <a href="/landing-page">here</a></p>
          </div>
        </div>
        ...
        <div className="portfolio-section">
          ...
          <h2>#TLDR: html, css, javascript, mobile first</h2>
            ...
            <p>The code repository for the product survey project is on <a href="https://github.com/Leddfoot/survey-form-fcc">Github</a>. It is deployed live at Heroku <a href="/survey">here</a></p>
          </div>
        </div>
        ...
        <div className="portfolio-section">
          ...
          <h2>#TLDR: html, css, javascript, mobile first, react, react hooks</h2>
            ...
            <p>The code repository for the pomodoro project is on <a href="https://github.com/Leddfoot/pomodoro_fcc">Github</a>. It is deployed live at Heroku <a href="/pomodoro">here</a></p>
          </div>
        </div>
